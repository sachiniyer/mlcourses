...
#+begin_src mermaid :file images/learnability-continual-learningp3.png
flowchart LR
   ind[In Distribution Sample]
   f[Feature Extractor]
   g["WP Head (class prediction)"]
...
#+RESULTS:
[[file:images/learnability-continual-learningp3.png]]
...
#+begin_src mermaid :file images/learnability-continual-learningp4.png
flowchart LR
   ind[In Distribution Sample]
   ood[Out of Distribution Sample]
   f[Feature Extractor]
...
#+RESULTS:
[[file:images/learnability-continual-learningp4.png]]
...
[[file:images/learnability-continual-learningp5.png]]
*** 5.2 Abalation Experiments
Performance decreases are clear.

[[file:images/learnability-continual-learningp6.png]]
** Conclusino
